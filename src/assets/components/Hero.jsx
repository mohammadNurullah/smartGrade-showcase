export default function Hero() {
  return (
    <>
      <section className="bg-[radial-gradient(50%_50%_at_50%_50%,#17956D_0%,#0F684C_100%)] pt-32 pb-20 -mt-[92px] md:-mt-[118px] p-5">
          ...
          <div className="grid md:grid-cols-2 items-center w-10/12 mx-auto">
            ...
            <div>
              <h1 className="text-4xl lg:text-[56px] font-bold leading-[1.1] mb-8">
                The Future of <br />
                Learning starts with students at the center
              </h1>
